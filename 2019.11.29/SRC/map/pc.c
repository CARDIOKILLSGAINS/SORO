...
int pc_equippoint(struct map_session_data *sd,int n){
	...
	if(sd->inventory_data[n]->look == W_DAGGER	||
		...
		if(ep == EQP_HAND_R && (pc_checkskill(sd,AS_LEFT) > 0))		//Removed Class Requirements for Dual Wield [Defect][SORO]
			return EQP_ARMS;
	}
	return ep;
}
...
int pc_jobid2mapid(unsigned short b_class)
{
	...
	//SORO CUSTOM CLASSES
	/*
		case JOB_SORO_SWORDSMAN:		return MAPID_SORO_SWORDSMAN;
		case JOB_SORO_KNIGHT:			return MAPID_SORO_KNIGHT;
		case JOB_SORO_LANCER:			return MAPID_SORO_LANCER;
		case JOB_SORO_DANCER:			return MAPID_SORO_DANCER;
		case JOB_SORO_WANDERER:			return MAPID_SORO_WANDERER;
		case JOB_SORO_SLAYER:			return MAPID_SORO_SLAYER;
		case JOB_SORO_HUNTER:			return MAPID_SORO_HUNTER;
		case JOB_SORO_ARCHER:			return MAPID_SORO_ARCHER;
		case JOB_SORO_ILLUSIONIST:		return MAPID_SORO_ILLUSIONIST;
		case JOB_SORO_SORCERESS:		return MAPID_SORO_SORCERESS;
		case JOB_SORO_AXE:				return MAPID_SORO_AXE;
		case JOB_SORO_MERCHANT:			return MAPID_SORO_MERCHANT;
		case JOB_SORO_BRAWLER:			return MAPID_SORO_BRAWLER;
		case JOB_SORO_FIGHTER:			return MAPID_SORO_FIGHTER;
	*/
		default:
			return -1;
	}
...
int pc_mapid2jobid(unsigned short class_, int sex)
{
	...
	//SORO CUSTOM CLASSES
	/*
		case MAPID_SORO_SWORDSMAN:			return JOB_SORO_SWORDSMAN;
		case MAPID_SORO_KNIGHT:				return JOB_SORO_KNIGHT;
		case MAPID_SORO_LANCER:				return JOB_SORO_LANCER;
		case MAPID_SORO_DANCER:				return JOB_SORO_DANCER;
		case MAPID_SORO_WANDERER:			return JOB_SORO_WANDERER;
		case MAPID_SORO_SLAYER:				return JOB_SORO_SLAYER;
		case MAPID_SORO_HUNTER:				return JOB_SORO_HUNTER;
		case MAPID_SORO_ARCHER:				return JOB_SORO_ARCHER;
		case MAPID_SORO_ILLUSIONIST:		return JOB_SORO_ILLUSIONIST;
		case MAPID_SORO_SORCERESS:			return JOB_SORO_SORCERESS;
		case MAPID_SORO_AXE:				return JOB_SORO_AXE;
		case MAPID_SORO_MERCHANT:			return JOB_SORO_MERCHANT;
		case MAPID_SORO_BRAWLER:			return JOB_SORO_BRAWLER;
		case MAPID_SORO_FIGHTER:			return JOB_SORO_FIGHTER;
	*/
		default:
			return -1;
	}
...
const char* job_name(int class_)
{
	...
	//SORO CUSTOM CLASSES
	//Does this need to be (NULL,1000)?
	/*
	case JOB_SORO_SWORDSMAN:
		return msg_txt(NULL,1000);
	case JOB_SORO_KNIGHT:
		return msg_txt(NULL,1001);
	case JOB_SORO_LANCER:
		return msg_txt(NULL,1002);
	case JOB_SORO_DANCER:
		return msg_txt(NULL,1003);
	case JOB_SORO_WANDERER:
		return msg_txt(NULL,1004);
	case JOB_SORO_SLAYER:
		return msg_txt(NULL,1005);
	case JOB_SORO_HUNTER:
		return msg_txt(NULL,1006);
	case JOB_SORO_ARCHER:
		return msg_txt(NULL,1007);
	case JOB_SORO_ILLUSIONIST:
		return msg_txt(NULL,1008);
	case JOB_SORO_SORCERESS:
		return msg_txt(NULL,1009);
	case JOB_SORO_AXE:
		return msg_txt(NULL,1010);
	case JOB_SORO_MERCHANT:
		return msg_txt(NULL,1011);
	case JOB_SORO_BRAWLER:
		return msg_txt(NULL,1012);
	case JOB_SORO_FIGHTER:
		return msg_txt(NULL,1013);
*/
	default:
...
//CUSTOM SORO STAT POINT COST

		sp += (low > 200) ? 4 : (low > 150 ) ? 3 : (low > 100) ? 2 : 1;
